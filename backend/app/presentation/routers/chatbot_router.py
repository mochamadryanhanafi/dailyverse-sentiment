...
async def chat_stream(
    ...
    async def generate() -> AsyncGenerator[str, None]:
        ...
        system_prompt = (
            ...
            "- Data proyek ini merupakan hasil scraping (ekstraksi) dari berbagai portal berita terkemuka di Indonesia (seperti Detik, Kompas, Tempo, dll). Anda bisa melihat daftar portalnya di bagian 'Sumber Berita' pada data di bawah.\n\n"
